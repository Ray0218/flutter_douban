import 'package:douban/Learn/anima_learn.dart';
import 'package:flutter/material.dart';

import '../../../Pagess/Home/pic_scan.dart';
import '../../../Pagess/my/myPage.dart';
import '../../../Pagess/Home/homePage.dart';
import 'homes/food_home.dart';
...
class _KLRootWidgetState extends State<KLRootWidget> {
  ...
  BottomNavigationBarItem _createBarItem(
      String normal, String select, String title) {
    return BottomNavigationBarItem(
      icon: Image.asset("images/tabbar/$normal", width: 32,gaplessPlayback: true,),
